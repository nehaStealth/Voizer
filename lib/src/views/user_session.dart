...
class UserSessionState extends StateMVC<UserSession>{
  ...
  Widget build(BuildContext context) {
    ...
    int hostIndex = sessionController.remoteUsers.indexWhere((user) => user.id == sessionController.hostUserId);
          ...
          child: Scaffold(
            ...
            body: Container(
              ...
              child: SingleChildScrollView(
                ...
                child: sessionController.isJoined ? Column(
                  children: [
                    Container(
                      height: 50,
                    ...
                    Container(
                      margin: const EdgeInsets.only(top: 20.0, left: 15, right: 15, bottom: 25),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () async {
                                  await sessionController.changeVolumeBroadcasting();
                                },
                                child: SizedBox(
                                  ...
                                  child: Column(
                                    children: [
                                      Image.asset(
                                        sessionController.isOnSpeaker ? 'assets/images/speaker.png' : 'assets/images/mute-speaker.png',
                                        height: 60,
                                        width: 60,
                                      ),
                              ...
                              InkWell(
                                onTap: () async {
                                  await sessionController.changeVolumeBroadcastingToBluetooth();
                                },
                                child: SizedBox(
                                  width: MediaQuery.sizeOf(context).width/ 4,
                                  child: Column(
                                    children: [
                                      Image.asset(
                                        sessionController.isOnBluetooth ? 'assets/images/active-bluetooth.png' : 'assets/images/bluetooth.png',
                                        height: 60,
                                        width: 60,
                                      ),
                                      const SizedBox(height: 10),
                            ...
                            children: [
                              Listener(
                                onPointerDown: (tapDown) {
                                  setState(() {
                                    sessionController.isUserHoldButton = true;
                                  });

                                  // Future.delayed(Duration(microseconds: 800)).then((value) {
                                  if(sessionController.isUserHoldButton) {
                                    sessionController.changeAudioState(true);
                                  }
                                  // });
                                },
                                onPointerUp: (tapUp) {
                                  setState(() {
                                    sessionController.isUserHoldButton = false;
                                  });
                                  sessionController.changeAudioState(false);
                                },

                                child: Image.asset(
                                  sessionController.isMuted ? 'assets/images/mute.png' : 'assets/images/unmute.png',
                                  height: 261,
                                  width: 261,
                                ),
                              ),
